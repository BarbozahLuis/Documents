...
class BancoDadosCrud {
  // Atributos
  static const String DB_NOME = 'cadastro.db'; // Nome do banco de dados
  static const String TABLE_NOME = 'cadastro'; // Nome da tabela de usuários

  static const String CREATE_CADASTRO_TABLE_SCRIPT = 
  ...
  Future<Database> _initDatabase() async {
    ...
    return openDatabase(
      ...
      onCreate: (db, version) async {
        await db.execute(CREATE_CADASTRO_TABLE_SCRIPT);
      },
    );
  }
