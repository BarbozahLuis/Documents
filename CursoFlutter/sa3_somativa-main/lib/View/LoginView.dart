...
import 'package:sa3_somativa/View/CadastroView.dart'; // Importa a página de cadastro
import 'package:sa3_somativa/View/TarefasView.dart'; // Importa a página da lista
              ...
              children: <Widget>[
                ...
                TextButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Cadastro()), // Navega até a página de cadastro
                    );
                  },
